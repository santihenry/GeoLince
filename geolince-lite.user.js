...
// @version      0.7
// @description  Muestra en vivo las coordenadas reales de la ronda y el lugar (calle, ciudad, provincia, pais), y las abre en un mapa aparte.
...
//
// Si buscas el AutoPlay (marcar, adivinar, pasar de ronda), ese esta en
// geolince.user.js, en el mismo repo.
    ...
    function createZoomControls(doc = document) {
        ...
        controlDiv.innerHTML = `
            <div class="gl-header" id="glHeader">
                <span class="gl-title">🐆 GeoLince Lite v0.7</span>
            ...
            <div class="gl-tabs" id="glTabs">
                ...
                <button class="gl-tab" id="glPart3Btn" title="Mostrar / ocultar Atajos">Atajos</button>
            </div>
            <div class="gl-body" id="glBody">
                ...
                <div class="gl-part" id="glPart3">
                    <div>
                        ...
                        <div class="gl-keys">Z ver mapa · X zoom+2 · C zoom−2 · N coords · M mapa
CTRL+Q panel · CTRL+E vistas · ALT+P ventana</div>
                    </div>
                </div>
            </div>
        `;
